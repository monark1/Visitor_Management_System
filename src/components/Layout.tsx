...
import { Users, Shield, Clock, BarChart3, Settings, LogOut } from 'lucide-react';
...
const Layout: React.FC<LayoutProps> = ({ children, currentView, onViewChange, userRole }) => {
  const navigationItems = [
    { id: 'dashboard', label: 'Dashboard', icon: BarChart3, roles: ['admin', 'employee'] },
    { id: 'register', label: 'Register Visitor', icon: Users, roles: ['security', 'admin'] },
